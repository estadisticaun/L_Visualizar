...
```{r histogramaedadgraduadosintervalos-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Histograma para la edad de estudiantes graduados, diferentes anchos de intervalo', out.width='100%'}
knitr::include_graphics("Imágenes/Histogramavariosintervalos.jpg")
```
