...
{\centering \includegraphics[width=1\linewidth]{Imágenes/histogramaedadgraduados} 
...
{\centering \includegraphics[width=1\linewidth]{Imágenes/Histogramavariosintervalos} 

}

\caption{Histograma para la edad de estudiantes graduados, diferentes anchos de intervalo}\label{fig:histogramaedadgraduadosintervalos-fig}
\end{figure}

Para la distribución de edades de los estudiantes graduados, se observa de la figura \ref{fig:histogramaedadgraduadosintervalos-fig} que un ancho de intervalo de 1 año es demasiado pequeño y un ancho de intervalo de 10 años es demasiado grande, mientras que los anchos de contenedor entre 3 y 5 años funcionan bien. Es de resaltar que no existe una regla general que indique de manera exacta el ancho de intervalo correcto, es más una elección visual que permita ver las tendencias generales sin llegar a mostrar los datos de manera puntual pero tampoco agruparlos en intervalos muy grandes que oculten las características de la distribución.
...
{\centering \includegraphics[width=0.8\linewidth]{Lineamientos-Visualizar_files/figure-latex/densidadadministrativos-fig-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{Lineamientos-Visualizar_files/figure-latex/densidadadministrativosrectangular-fig-1} 
...
{\centering \includegraphics[width=1\linewidth]{Imágenes/histogramagraduadossexo} 
...
{\centering \includegraphics[width=0.8\linewidth]{Lineamientos-Visualizar_files/figure-latex/densidadadministrativosexo-fig-1} 
