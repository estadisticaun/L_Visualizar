...
{\centering \includegraphics[width=1\linewidth]{Lineamientos-Visualizar_files/figure-latex/usocolordistinguir-fig-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{Lineamientos-Visualizar_files/figure-latex/manejotextos-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/barrasadmitidosnivel-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/barrasadmitidosnivelhorizontal-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/graduadosporgrupoedad-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/barrasagrupadasservicioedad-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/barrasagrupadasserviciosede-fig-1} 
...
{\centering \includegraphics[width=1\linewidth]{Imágenes/barrasagrupadas} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/barrasaplidasserviciosexo-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/diagramapuntos-fig-1} 
...
{\centering \includegraphics{Lineamientos-Visualizar_files/figure-latex/mapadecalorcorrecto-fig-1} 
